...
public class ChatAssistantDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public ChatAssistantDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
